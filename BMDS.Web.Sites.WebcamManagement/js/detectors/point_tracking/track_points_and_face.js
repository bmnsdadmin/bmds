(function exampleCode() {
	...
	webcamManager.initCurrentExample = function(brfManager, resolution, draw) {
	...
	webcamManager.updateCurrentExample = function(brfManager, imageData, draw) {
		...
		if(points.length !== _numTrackedPoints) {
			...
			webcamManager.dom.updateHeadline("BRFv4 - Basic - Point Tracking\n" +
	...
	webcamManager.dom.updateHeadline("BRFv4 - basic - point tracking - track points and a face.\n" +
		"Click eg. on your face to add a bunch of points to track.");

	webcamManager.dom.updateCodeSnippet(exampleCode + "");
