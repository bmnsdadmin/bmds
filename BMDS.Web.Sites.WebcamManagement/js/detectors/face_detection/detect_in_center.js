(function exampleCode() {
	...
	function printSize(rects, printAlwaysMinMax) {
		...
		if(maxWidth > 0) {
			...
			webcamManager.dom.updateHeadline("BRFv4 - basic - face detection - detect face in " +
				"center\nLimit detection area to the center of the image. " + str);
		}
	}

	webcamManager.dom.updateHeadline("BRFv4 - basic - face detection - detect face in center\n" +
