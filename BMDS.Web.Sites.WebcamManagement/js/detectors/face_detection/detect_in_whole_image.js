(function exampleCode() {
	...
	function printSize(rects, printAlwaysMinMax) {
		...
		if(maxWidth > 0) {
			...
			webcamManager.dom.updateHeadline("BRFv4 - basic - face detection - detect faces in " +
				"the whole image\nSet most of the/the whole image as detection area. " + str);
		}
	}

	webcamManager.dom.updateHeadline("BRFv4 - basic - face detection - detect faces in the " +
