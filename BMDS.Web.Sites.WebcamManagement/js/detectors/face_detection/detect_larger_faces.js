(function exampleCode() {
	...
	function printSize(rects, printAlwaysMinMax) {
		...
		if(maxWidth > 0) {
			...
			webcamManager.dom.updateHeadline("BRFv4 - basic - face detection - detect large " +
				"faces\nCome closer to the webcam to see detection results. " + str);
		}
	}

	webcamManager.dom.updateHeadline("BRFv4 - basic - face detection - detect large faces\n" +
